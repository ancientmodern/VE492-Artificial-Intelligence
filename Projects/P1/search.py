    ...
    while True:
        ...
        if state not in closed:
            ...
            for child in problem.getSuccessors(state):
                fringe.push((child[2], path + [child[0]]))
    ...
    while True:
        ...
        if state not in closed:
            ...
            for child in problem.getSuccessors(state):
                ...
                fringe.update((path + [child[0]], newCost, child[2]), newCost)
...
def aStarSearch(problem, heuristic=nullHeuristic):
    ...
    while True:
        ...
        if state not in closed:
            ...
            for child in problem.getSuccessors(state):
                newCost = cost + child[1]
                fringe.push((path + [child[0]], newCost, child[2]), newCost + heuristic(child[2], problem))
