...
class GreedyBustersAgent(BustersAgent):
    ...
    def chooseAction(self, gameState):
        ...
        for ghost_pos in most_likely_positions:
            ghost_distances.append(self.distancer.getDistance(pacmanPosition, ghost_pos))
        closet_ghost_pos = most_likely_positions[ghost_distances.index(min(ghost_distances))]
        successor_distances = []
        for action in legal:
            successor_distances.append(
                self.distancer.getDistance(Actions.getSuccessor(pacmanPosition, action), closet_ghost_pos))
        return legal[successor_distances.index(min(successor_distances))]
